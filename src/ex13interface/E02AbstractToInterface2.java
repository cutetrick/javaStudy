...
/*
 추상클래스를 인터페이스로 변경하기
  abstract class => interface
 	멤버메서드인 경우 piblic abstract를 제거한다.
...
/*
 ...
 extends는 "상속"이라 표현하고, implements 는 "구현"이라 표현한다.
 */
class PersonalNumberStorageImpl implements IPersonalNumberStorage {
	...
	/*
	 추상메서드를 오버라이딩 한 후 재정의한다.
	 주민번호와 이름을 매개변수로 받은 후 DTO인스턴스를 배열에 추가한다.
	 */
	@Override
	public void addPersonalInfo(String name, String juminNum) {
