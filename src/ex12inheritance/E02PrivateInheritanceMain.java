...
class Account {
	...
	/*
	 ...
	 default라도 접근은허용된다. 즉 protected를 지워도 상관없다.
	 */
...
class SavingAccount extends Account {
	...
	public SavingAccount (int initVal) {
		...
		/*
		 ...
		 super()라는 문장, 즉 매개변수가 없는 디폴트 생성자를
		 호출하는 문장이 자동으로 삽입되는데 부모클래스에는 이런 생성자가
		 정의되지 않았으므로 에러가 발생하는것이다.
		 */
	}
...
//		sa.money =10000; //에러발생
		...
		/*
		 ...
		 외부이기 때문이다. 즉 private멤버는 무조건 클래스 내부에서만
		 접근을 허용한다.
		 */
