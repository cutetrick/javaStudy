...
/*
 오버라이딩(Overriding)
 : 클래스가 상속관계에 있을때 하위클래스에서 상위클래스의 멤버메서와 완전히
 동일한 모양으로 메서드를 재정하는 것을 말한다.
...
public class E06Overriding {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 물어보는 것과 동일한 원리라 생각하면 된다.
		 */
		baseSpeaker.showState(); // 볼륨과 베이스가 출력된다.
		
		System.out.println();
		/*
		 부모 클래스의 참조변수로 자식인스턴ㄴ스를 참조할 수 있다.
		 상속관계이므로 가능하다.
		 */
...
//		speaker.setBase(40); //에러발생
		/*
		 접근범위는 앞에서 설명한 바와 같이 부모까지로 제한되지만 오버라이딩
		 된 메서드가 있다면 자식쪽의 메서드가 호출된다.
		 */
		speaker.showState();
	}
