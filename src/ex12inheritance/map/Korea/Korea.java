package ex12inheritance.map.Korea;
...
public class Korea {
	...
	public void publicMethod(String loc) {
		 ...
		 * 동일패키지, 다른패키지, 외부클래스, 상속 등 모든 영역에서 접근할 수
		 * 있다.
		 */
	...
	protected void protectedMethod(String loc) {
		/*
		 * 서로 패키지가 다른 2개의 클래스가 상속관계를 가지고 있따면 접근을 허용한다.
		 * 즉 default보다 좀 더 넓은 접근범위를 가지고 있다.
		 */
