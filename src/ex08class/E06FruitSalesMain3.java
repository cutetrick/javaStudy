...
class FruitSeller3 {
	...
	/*
	 ...
	 호출 할 수 없으므로 한번 이상 초기화되지 않음이 문법적으로 보장된다.
	...
	public FruitSeller3(int money, int appleNum, int price) {
		myMoney = money;
		numOfApple = appleNum;
		// 이 부분을 삭제하면 에러가 발생한다. 상수는 반드시 초기화되어야 하기때문이다.
		APPLE_PRICE = price;
	}
...
class FruitBuyer3 {
	...
	public FruitBuyer3(int _myMoney, int appleNum) {
		myMoney = _myMoney;
		numOfApple = appleNum;
	}
...
public class E06FruitSalesMain3 {
	...
	public static void main(String[] args) {
		/*
		 생성자를 사용해서 인스턴스를 생성하면 아래오 같이 생성과 동시에
		 초기화까지 할 수 있다. 따라서 초기화 메서드를 사용하는것보다 간단한
		 코드로 작성할 수 있는 장점이 있다.
		 */
