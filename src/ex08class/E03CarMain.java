...
class Car {
	...
	void drive() {
		/*
		 owner 인스턴스 이므로 이름을 출력하기위해'변수명.name'과 같이
		 기술해야한다.
		 */
...
public class E03CarMain {
	...
	public static void main(String[] args) {
		...
		/*
		 자동차2: 초기화 메서드를 호출하는 대신 멤버변수에 직접 접근하여
		  인스턴스를 초기화한다. 이 경우 인스턴스를 생성할때마다 동일한
		...
		car2.showCarInfo();
		/*
		 자동차3: 매개변수가 있는 초기화 메서드를 사용하여 인스턴스를 생성한다.
		 	 이 경우 매개변수를 통해 다양한 값을 전달 할 수 있으므로 여러형태의
		...
		/*
		 ...
		 예외가 발생하게 된다. 즉, 인스턴스는 초기화 이후 사용해야한다.
		 */
		Car car4 = new Car();
		car4.showCarInfo();
	}
