...
/*
 Thread(쓰레드)
 - 쓰레드의 생성은 Thread 클래스를 상속하는것부터 시작한다.
 - 해당 방법은 쓰레드로 생성할 클래스가 다른 클래스를 상속할
 필요가 없을때 사용 할 수 있다.
...
public class Ex01ThreadStart {
	...
	public static void main(String[] args) {
		...
		/*
		 쓰레드 인스턴스를 통한 쓰레드 생성 및 실행. 쓰레드가 정상적응로
		...
		/*
		 run()메서드를 통해 실행하면 단순한 실행만 될 뿐 쓰레드가
		 생성되지 않는다. 따라서 st1의 작업이 완료되어야만 st2가 
		 실행된다. 즉 순차적인 실행이 된다.
		 */
//		st1.run();
//		st2.run();
