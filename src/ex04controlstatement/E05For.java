...
/*
 for문
 : while 문과 같은 반복문으로 초기값, 조건식, 증감식이 한줄에 있어
...
public class E05For {
	...
	public static void main(String[] args) {
		...
		System.out.println("1~10사이 2의배수의 합(방법 1):" + total);
		...
		System.out.println("1~10사이 2의배수의 합(방법 2):" + total);
		...
		for(int j=0 ; j<=5; j++);
		{
			System.out.println("여긴 어디 나는 누구?");
		}
		/*
		 for문의 초기식에서 선언된 변수 j는 for문이 종료되는 순간 메모리에서 소멸된다..
		 여기서 사용된 변수 j는 지역변수(Local variable)이라고 한다.
...
//		System.out.println("위 for문에서 선언한 변수 j="+ j);
		...
		/* for문의 초기값을 외부 (넓은지역, 여기서는 main메서드 지역) 에서 선언아면
		...
		/*
		 연습문제1]구구단을 출력하는 프로그램 for문으로 작성하시오.
		 */
		//단에 해당하는 for문
