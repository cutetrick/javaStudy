...
public class E03While {
	...
	public static void main(String[] args) {
		...
		/*
		 시나리오] 1~10까지의 합을 구하는 프로그램을 while문으로 작성.
		 */
		...
		while(j<=10){
			...
			sum +=j ;// => sum = sum + j;이와 같이 작성할 수 있다.
			j++;//반복문 탈출을 위한 증가식
		}
		...
		/*
		 시나리오] 1~ 100까지의 정수중 3의 배수이거나 4의 배수인 정수의 합을 구하는
		 프로그램을 while문을 이용해서 작성하시오.
		 */
		int total = 0;
		// k가 100이하일때만 반복한다.
		int k = 1;
		//3의배수 혹은 4의 배수이므로 논리 Or를 사용한다
		while(k<=100){
...
//				조건에 맞는 k를 확인용르 출력한다.
		...
		/*
		 * 구구단을 출력하는 프로그램을 while 문으로 작성하시오
		 */
		int dan = 2;
		while(dan<=9){
			int su = 1;
