...
public class E02StringMethod1 {
	...
	public static void main(String[] args) {
		System.out.println("String 클래스의 주요 메서드1");
		...
		*/ 
		...
		System.out.println("str1의 길이:" + str1.charAt(1));
		System.out.println("str2의 길이:" + str2.charAt(2));
		
		/*
		 3] compareTo() : 2개의 문자열의 첫번째 문자부터 순차적으로 비교하면서
		 	앞문자의 아스키코드가 크면 양수를 반환하고, 뒷 문자의 아스키코드가
		 	크면 음수를 반환한다. 두 문자열이 같을때 0을 반환한다.
		 */
		...
		/*
		 4] concat(): 두개의 문자열을 연결한다. print()문에서 +와 동일한
		 		역할이다.
		 */
		...
		/*
		 5] contains(): 문자열에 특정 문자열이 포함되었는지 판단하여
		 		포함되었다면 true 를 반환한다.
		 */
