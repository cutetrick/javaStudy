...
public class E02StringMethod2 {
	...
	public static void main(String[] args) {
		...
		//한글 '야' :50556
		System.out.println("str2 첫번째 문자의 아스키코드:" + str2.codePointAt(2));
		...
		/*
		 9] format() : 출력형식을 지정하여 문자열로 반환할때 사용한다. printf()와
		...
		10]indexOf() : 문자열에서 특정 문자열의 시작인덱스를 반환한다.
			만약 존재하지 않으면 -1을 반환한다. 인덱스는 항상 0부터 시작하므로
			 -1 은 해당문자열이 없는 의미가 된다.
		 */
		System.out.println("### 10 ###");
		String emmail = "hong@daum.net";
		System.out.println(str1.indexOf("ava"));;
		System.out.println(str1.indexOf("J"));
		System.out.println((emmail.indexOf("@")!=-1)?
				"이메일 형식맞음" : "이메일형식아님");
