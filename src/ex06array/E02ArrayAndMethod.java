...
public class E02ArrayAndMethod {
	...
	public static void main(String[] args) {
		...
		/*
		 배열을 선언과 동시에 초기화한다. 초기값의 갯수를 ㅌㅇ해 크기가 결정된다.
		 생성된 배열 인스턴스의 주소값을 int형 배열변수인 arr에 할당하게 된다.
		 */
		int [] arr = {1, 2, 3, 4, 5};
		//배열변수만 선언했고 아직은 참조할 인스턴스가 없는 상태
		int [] ref;
		...
		/*
		 ...
		 배열에 저장된 값 자체가 아닌 Heap영역에 생성된 메모리의 주소값을 저장하게 된다.
		 */
