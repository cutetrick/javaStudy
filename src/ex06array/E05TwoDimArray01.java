...
public class E05TwoDimArray01 {
	...
	public static void main(String[] args) {
		...
		// 배열명을 출력하면 참조값이 나온다.
		System.out.println("arr2 배열명 출럭:" + arr2);
		// 0번 인덱스는 1이 출력
		System.out.println("arr2[0] 원소 출럭:" + arr2[0]);
		//초기화 하지 않은 요소는 0이 출력된다.
		System.out.println("arr2[3] 원소 출럭:" + arr2[3]);
		...
		/*
		 ...
		 할 수 있다.
		 */
		System.out.println("배열의 세로크기:" + arr.length); //3출럭
