...
public class E02AnonymousClass {
	...
	public static void main(String[] args) {
		...
		//자식쪽의 toStirng()이 호출되어 이름과 팀명까지 출력된다.
		System.out.println(s2);
		/*
		 GirlGroup클래스를 상속받은 익명클래스 정의
		 : Singer타입의 변수에 GrilGroup을 상속받은 익명클래스를
		 생성해서 그 참조값을 할당한다.
		 개념적으로 new GirlGroup() {};
		 	=> 익명 extends GirlGroupd과 같다.
	 ...
	 */
		...
		/*
		 ...
		 애초에 기능이 있는 메서드가 필요하지 않다.따라서 인터페이스에
		 정의된 추상메서드를 오버라이딩하여 익명클래스를
		 만드는 경우가 매우 많다.
		 */
