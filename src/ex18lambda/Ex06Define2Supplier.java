...
public class Ex06Define2Supplier {
	...
	public static void main(String[] args) {
		/*
	 	Supplier<T>
	 	: 공급자라는 의미를 가지고 있다. 매개변수는 없지만 리턴값은 있는 get()
	 	메서드가 정의되어있다. 주로 데이터를 생성하여 리턴한다.
	 
	 	interface Supplier<T> {
	 		T get();
	 	}
	 		여기서 타입매개변수 T는 추상메서드의 반환타입으로 지정된다.
		 */
		/*
		 타입매개변수로 Integer클래스를 사용했으므로 정수값을 반환받는 용도로
		 ...
		 */
		System.out.println(" ### Iterator문으로 출력1");
