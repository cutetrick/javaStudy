...
/*
 캡슐화 (Encapsulation)
 : 여러가지 업무 로직을 하나로 묶는다는 의미와, 업무늬 순서까지
...
차후에는 별도의 분석 절차없이 해당 클래스의 doProcess() 메서드만
...
public class E05Encapsulation {
	...
	public static void main(String[] args) {
		...
		CongratulationPoint congratulationPoint = new CongratulationPoint();//축하포인트지급
		...
		System.out.println("==============================");
		// 아래 메서드 호출을 통해 업무를 순서에 맞게 진행 할 수 있다.
