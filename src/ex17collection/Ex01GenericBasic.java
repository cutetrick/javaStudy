...
//오렌지 전용박스 : Orange 인스턴스만 저장 할 수 있다.
class OrangeBox {
	//멤버변수: 오렌지 인스턴스
	Orange item;
	//setter메서드: 저장하다
...
public class Ex01GenericBasic {
	...
	public static void man(String[] args) {
		...
		orange1.showInfo();
		/*
		 상자1은 오렌지 전용박스이므로 다른과일(즉 인스턴스)를 저장 할 수 없다.
		...
		/*
		 ...
		 발생하여 실행 할 수 없는 코드가 된다. 즉 자료형에는 안전하다고
		 볼 수 있다.
		 */
