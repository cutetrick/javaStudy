...
/*
 ...
 오버라이딩 해야만 중복을 제거 할 수 있다.
 - List가 배열의 특성을 가진다면, Set은 집합의 특성을가진다. 
 */
...
public class Ex04HashSet1 {
	 ...
	 */
	 ...
	 /*
	  아래 2개의 문장도 위와 동일한 인스턴스 생성 문장으로 사용 할 수 있다.
	  */
	 //	 HashSet set = new HashSet();
//	 HashSet<Object> set = new HashSet<>();
	 
	 /*
	  3가지의 기본클래스와 우리가 정의한 Teacher 클래스의 인스턴스를
	  생성한다.
	  */
...
//	2. 인출할 인스턴스가 있는지 확인한다
	while(itr.hasNext()) {
		...
		/*
		 ...
		 우리가 직접 정의한 클래스에 대해ㅓ만 instanceof를 통해 타입을
		 확인 후 다운캐스팅하여 출력한다.
	...
	System.out.println(set.remove(varString2) ?
			"varString2 삭제0. 성공" : "varString2 삭제 실패");
