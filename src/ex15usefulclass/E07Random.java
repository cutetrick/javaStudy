...
public class E07Random {
	...
	public static void main(String[] args) {
		/*
		 Random클래스는 인스턴스 생성시 전달되는 인수를 기반으로 난수를
		 생성한다., 이것을 Seed(씨앗)이라고 표현한다. 만양ㄱ 동일한 Seed를 
		 사용하면 항상 동일한 패턴의 난수가 생성되는데 이를 가짜난수
		 (Pseudo-random nimber)라고 한다.
		 */
		...
		/*
		 씨드를 부여하려면 setSeed()메서드를 사용한다. 이때 현쟂시간을
		...
		/*
		 nextInt()에 인수가 없는 경우에는 음수, 양기가 혼용된 난수가
