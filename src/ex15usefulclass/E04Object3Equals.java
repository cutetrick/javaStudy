...
class MyClass {
	...
	/*
	 ...
	 재정의한다. 인스턴스가 가진 멤버변수의 값에 대한 비교를 통해
	  동일여부를 판단한다. equals() 메서드의 매개변수 타입은 모든
	  인스턴스를 대상으로 하므로 Object형으로 정의되어있다.
	 */
	@Override
	public boolean equals(Object obj) {
		/*
		 매개변수로 전달된 인스턴스를 Object로 받으면 업캐스팅이
		 되므로 다운캐스팅 이후에 비교를 진행해야한다.
...
public class E04Object3Equals {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 만약 오버라이딩 한 equals()를 삭제한 후 실행하면 다르다는 결과가
		 출력된다. 즉 오버라이딩이 필요없는 경우는 기본클래스일때만 가능하다.
		 */
