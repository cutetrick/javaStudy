...
public class E05Date {
	...
	/*
	 Calendar 클래스를 통해 얻은 인슽넌스를 초로 변환한 후 매개변수로
	...
	public static void main(String[] args) {
		/*
		 ...
		 생성할 수 없고, 유틸리티 메서드를 통해 참조값을 얻어와야한다.
		 */
	...
	/*
	 ...
	 서식의 날짜를 파싱하여 구한 날짜 인스턴스를 통해 계산한다.
	 */
	//오늘 날짜: 0000-00-00 형식
	...
	public static long myDiffDate(String today, String future) {
		...
		try {
			/*
			 매개변수를 통해 전달된 2 개의 문자열은 날짜의 서식이 서로 다르다.
			...
			/*
			 getTime()으로 얻어오는 시간은 13자리인 정수값인데 10자리까지는
			  ...
			  또한 하루는 86400초 이므로 아래와 같이 남은 날짜를 계산 할 수 있다.
			 */
