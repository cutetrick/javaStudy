...
//		System.out.println("나는 "개발자"가 되고싶어요");
		...
		// printf() : 문자열을 서식에 맞춰 출력할 떄 사용한다. 
		int kor=81, eng=97, math=79;
		// 정수는 %d, 줄바꿈은 %n으로 표현한다.
		System.out.printf("국어:%d, 영어:%d, 수학:%d%n",
				kor, eng, math);
		/*
		  같은 출력 문장이지만 println()을 사용하면 아래와 같이 문자열과
		  변수를 분리하여 작성해야하므로 조금 더 복잡하다. 
		 */
		System.out.println("\n국어:" + kor +", 영어" + eng
				+", 수학:" + math);
	
		/*
		  실수는 %f를 사용한다. 또한 정수와 실수의 연산이므로 결과는 실수가
		  반환되어 double 타입의 변수에 대입해야한다.
		 */
