...
public class E06LocalVariable {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 변수를 선언할 수 없다. 큰 지역에서 이미 선언되어 메모리에 상주하고 있기
		 때문이다.
		 */
		//이 부분을 주석처리하지 않으면 아래 코드에서 에러가 발생한다.
//		int num = 9;
		
		/*
		 main보다 좁은 지역인 if문의 블럭을 생성한 후  변수 num울 선언한다.
		...
		/*
		main지역에서 선언한 변수 num은 메모리에 아직 상주하고 있지만 해당
		메서드는 크기가 동일한 다른 지역에 정의되어있었으므로 같은 이름의 변수를
		선언할 수 있다.
