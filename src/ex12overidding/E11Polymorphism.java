...
/*
 ...
 참조변수의 타입에 따라 다양한 형태의 인스턴스를 이용할 수 있는 특성을 말하낟.
...
public class E11Polymorphism {
	...
	public static void main(String[] args) {
		...
		/*
		 이질화: 부모타입의 참조변수로 지식인스턴스를 참조하는것을 말한다.
		 이경우 자식 클래스에서 새롭게 정의한 멤버는 접근 할 수 없다.
		 만약 접근해야 한다면 자식타입으로 강제형변환(다운캐스팅)을 해야한다.
		 */
		...
		//부모 팜조변수로 자식 인스턴스를 참조한 두번째 변수 생성
		...
		/*
		 java에서 생성한 모든 클래스는 ob-ject 클래스를 상속한다.
		 따라서 모든 인스턴스는 ob-ject의 참조변수로 참조가 가능하다.
