...
/*
 static 블럭
 : 동일 클래스내 main() 메서드보다 먼저 실행되는 블럭으로 main 메서드의
...
public class E02StaticBlockMain {
	...
	static {
		...
		/* 블럭내에서만 사용할 수 있는 변수로, 블럭내에서는 일반변수를 생성한 후
		사용할 수 있다*/
		int localVar;
		localVar = 1000;
...
//		instanceMethod();
	...
	public static void main(String[] args) {
		...
		/*
		 static블럭내에서 선언된 변수는 지역변수이므로 main 메서드에서는
		 사용할 수 없다.해당지역에서만 사용 할 수 있다.
		 */
//		System.out.println("localVar="+ localVar);
